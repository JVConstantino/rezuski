...
export const LOGO_URL = 'https://rezuski-server-rezuski-db-server.h7c5nc.easypanel.host/storage/v1/object/public/property-images/public/ui/logo.png';
export const LOGO_URL_FALLBACK = '/logo.png';
export const LOGO_URL_SUPABASE = 'https://rezuski-server-rezuski-db-server.h7c5nc.easypanel.host/storage/v1/object/public/general-files/public/LOGO.png';
